(function (h, e) {
    ...
    function P(a) {
        ...
        try {
            ...
            (b = c.getContext("experimental-webgl")) ||
    ...
    function ba(a, b) {
        ...
        function d(a) {
            if (!1 !== f.enabled) {
                ...
                if (x === w.ROTATE) {
                    ...
                    r.subVectors(h, D);
                    f.rotateLeft(
                        ((2 * Math.PI * r.x) / d.clientWidth) * f.rotateSpeed
                    );
                    f.rotateUp(
                        ((2 * Math.PI * r.y) / d.clientHeight) * f.rotateSpeed
                    );
                    D.copy(h);
                    G &&
        ...
        function k(a) {
            if (!1 !== f.enabled && !0 !== f.noZoom && x === w.NONE) {
                ...
                0 < d
                    ? ((f.object.fov =
                          f.object.fov < f.maxFov
                              ? f.object.fov + 1
                              : f.maxFov),
                      f.object.updateProjectionMatrix())
                    : 0 > d &&
                      ((f.object.fov =
                          f.object.fov > f.minFov
                              ? f.object.fov - 1
                              : f.minFov),
                      f.object.updateProjectionMatrix());
                f.update();
            ...
            if (!1 !== f.enabled) {
                ...
                switch (a.touches.length) {
                    case 1:
                        ...
                        r.subVectors(h, D);
                        f.rotateLeft(
                            ((2 * Math.PI * r.x) / d.clientWidth) *
                                f.rotateSpeed
                        );
                        f.rotateUp(
                            ((2 * Math.PI * r.y) / d.clientHeight) *
                                f.rotateSpeed
                        );
                        D.copy(h);
                        G &&
        ...
        var S = new e.Quaternion().setFromUnitVectors(
                a.up,
                new e.Vector3(0, 1, 0)
            ),
            W = S.clone().inverse(),
        ...
        this.pan = function (a, d) {
            var b =
                f.domElement === document ? f.domElement.body : f.domElement;
            if (f.object instanceof e.PerspectiveCamera) {
                ...
                f.object instanceof e.OrthographicCamera
                    ? (f.panLeft(
                          (a * (f.object.right - f.object.left)) / b.clientWidth
                      ),
                      f.panUp(
                          (d * (f.object.top - f.object.bottom)) /
                              b.clientHeight
                      ))
                    : console.warn(
        ...
        this.update = function (a) {
            ...
            R = Math.max(
                ...
                Math.min(this.maxAzimuthAngle, R)
            );
        ...
        this.update = function (a) {
            if (!1 !== c.enabled) {
                var b = c.deviceOrientation.alpha
                        ? e.Math.degToRad(c.deviceOrientation.alpha) +
                          c.alphaOffsetAngle
                        : 0,
                    ...
                    f = c.deviceOrientation.gamma
                        ...
                        : 0,
                    p = c.screenOrientation
                        ? e.Math.degToRad(c.screenOrientation)
                        : 0,
    ...
    function da(a) {
        ...
        a.controlButtons = a.controlButtons || [
            "fullscreen",
            "setting",
            "video",
        ];
    ...
    var ja = "^0.105.2".replace(/[^0-9.]/g, ""),
        ...
        ea = {
            load: function (a, b, c, d) {
                ...
                // This was causing the infospots to not load so I removed it >:(
                // if (void 0 !== l)
                //     return (
                //         b &&
                //             setTimeout(function () {
                ...
                for (b in this._valuesEnd)
                    if (void 0 !== this._valuesStart[b]) {
                        var e = this._valuesStart[b] || 0,
                            l = this._valuesEnd[b];
                        l instanceof Array
                            ? (this._object[b] = this._interpolationFunction(
                                  l,
                                  c
                              ))
                            : ("string" === typeof l &&
                    ...
                    if (0 < this._repeat) {
                        ...
                        for (b in this._valuesStartRepeat)
                            "string" === typeof this._valuesEnd[b] &&
                                (this._valuesStartRepeat[b] += parseFloat(
                                    this._valuesEnd[b]
                                )),
                                this._yoyo &&
    ...
    z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
        ...
        enableRaycast: function (a) {
            this.raycast =
                void 0 === a || a ? this.originalRaycast : function () {};
        },
        show: function (a) {
            a = void 0 === a ? 0 : a;
    ...
    I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        createSettingButton: function () {
            ...
            b.deactivate = function () {
                ...
                a.activeSubMenu &&
                    a.activeSubMenu.visible &&
                    a.activeSubMenu.hide();
                a.mainMenu &&
                    a.mainMenu._width &&
                    (a.mainMenu.changeSize(a.mainMenu._width),
        ...
        createVideoControlSeekbar: function () {
            function a(a) {
                ...
                p =
                    a.clientX ||
                    (a.changedTouches && a.changedTouches[0].clientX);
        ...
        createMenuItem: function (a) {
            ...
            c.setIcon = function (a) {
                this.icon &&
                    (this.icon.style.backgroundImage = "url(" + a + ")");
            };
        ...
        createSubMenu: function (a, b) {
            ...
            k.addHeader(a)
                .addIcon(void 0, !0, !0)
                .addEventListener(
                    d.TOUCH_ENABLED ? "touchend" : "click",
                    c,
                    !1
                );
    ...
    n.prototype = Object.assign(Object.create(e.Mesh.prototype), {
        ...
        setupTransitions: function () {
            ...
            this.enterTransition = new r.Tween(this)
                ...
                .start();
            this.leaveTransition = new r.Tween(this).easing(
                r.Easing.Quartic.Out
            );
        },
    ...
    B.prototype = Object.assign(Object.create(n.prototype), {
        ...
        load: function () {
            ...
            k.addEventListener(
                ...
                function () {
                    this.videoProgress =
                        0 <= k.duration ? k.currentTime / k.duration : 0;
                    this.dispatchEvent({
                        type: "panolens-viewer-handler",
        ...
        composePanorama: function () {
            ...
            for (var d = this._parameters.useWebGL, e = 0; e < b; e++)
                for (
                    var k = {}, h = 0;
                    h < a;
                    k = { $jscomp$loop$prop$url$1: k.$jscomp$loop$prop$url$1 },
                        h++
                )
    ...
    Z.prototype = Object.assign(Object.create(y.prototype), {
        ...
        load: function (a) {
            ...
            ((a = a || this.panoId || {}), this.gsvLoader) &&
                this.loadGSVLoader(a);
        },
    ...
    da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        tweenControlCenter: function (a, b, c) {
            ...
            if (this.control === this.OrbitControls) {
                ...
                k = Math.abs(
                    h.angleTo(k) +
                        (0 >= h.y * l.y ? l.angleTo(a) : -l.angleTo(a))
                );
                k *= l.y < h.y ? 1 : -1;
                h = { left: 0, up: 0 };
                var n = (d = 0);
        ...
        tweenControlCenterByObject: function (a, b, c) {
            ...
            if (d) {
                ...
                this.tweenControlCenter(
                    a.getWorldPosition(new e.Vector3()),
                    b,
                    c
                );
        },
        ...
        onMouseDown: function (a) {
            a.preventDefault();
            this.userMouse.x =
                0 <= a.clientX ? a.clientX : a.touches[0].clientX;
            this.userMouse.y =
        ...
        onMouseUp: function (a) {
            ...
            var b =
                (this.userMouse.x >= a.clientX - this.options.clickTolerance &&
                    this.userMouse.x <=
                        a.clientX + this.options.clickTolerance &&
                    this.userMouse.y >=
                        a.clientY - this.options.clickTolerance &&
                    this.userMouse.y <=
                        a.clientY + this.options.clickTolerance) ||
                (a.changedTouches &&
                    this.userMouse.x >=
            ...
            if (
                !a ||
                !a.target ||
                a.target.classList.contains("panolens-canvas")
            )
                if (
                    (a.preventDefault(),
                    (a =
        ...
        onTap: function (a, b) {
            ...
            this.raycasterPoint.x =
                ((a.clientX - c.left) / e.clientWidth) * 2 - 1;
                ...
                function (a) {
                    if (
                        ...
                        (this.hoverObject === a ||
                            ...
                            (a.element.left &&
                                "none" !== a.element.left.style.display) ||
                            (a.element.right &&
                                "none" !== a.element.right.style.display))
                    )
                        if (this.checkSpriteInViewport(a)) {
                            var b = this.getScreenVector(
                                a.getWorldPosition(new e.Vector3())
                            );
            ...
            this.loadAsyncRequest(u.ViewIndicator, function (b) {
                if (0 !== b.loaded) {
                    ...
                    a.addUpdateCallback(function () {
                        ...
                        a.currentPanoAngle =
                            a.camera.rotation.y - e.Math.degToRad(90);
