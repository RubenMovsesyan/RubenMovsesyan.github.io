 ...
 */
 ...
 class Vector3 {
    ...
    add(other) {
        ...
        for (let i = 0; i < this.elements.length; i++) { this.elements[i] += other.elements[i] }
    ...
    normalize() {
        ...
        for (let i = 0; i < this.elements.length; i++) { this.elements[i] /= m }
...
class Matrix3 {
    constructor(opt_src) {
        var i, s, d;
        if (opt_src && typeof opt_src === 'object' && opt_src.hawOwnProperty('elements')) {
            s = opt_src.elements;
    ...
    multiply(other) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            e[i] = ai0 * b[3] + ai1 * b[4] + ai2 * b[5];
            e[i] = ai0 * b[6] + ai1 * b[7] + ai2 * b[8];
        }
